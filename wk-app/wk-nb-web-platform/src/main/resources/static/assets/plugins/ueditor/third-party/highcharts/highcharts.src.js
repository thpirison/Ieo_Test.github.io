...
SVGElement.prototype = {
	...
	attr: function (hash, val) {
		...
		// setter
			...
			// Update transform. Do this outside the loop to prevent redundant updating for batch manage
			// of attributes.
			if (doTransform) {
	...
	*/
	...
	css: function (styles) {
		...
		if (isIE && !hasSVG) { // legacy IE doesn't support manage style attribute
			if (textWidth) {
				delete styles.width;
			}
...
SVGRenderer.prototype = {
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		/**
		 * This function runs after manage text or padding, but only if padding is changed
		 */
		...
		attrSetters.align = function (value) {
			...
			return false; // prevent manage text-anchor on the group
		};
...
var VMLRendererExtension = { // inherit SVGRenderer
	 ...
	 * for manage the CSS style to all associated members.
	 *
	 * @param {Number} x
	 * @param {Number} y
	 * @param {Number} width
...
Series.prototype = {
	...
	invertGroups: function () {
		...
		// On subsequent render and redraw, just do setInvert without manage up events again
