...
vjs.formatTime = function(seconds, guide) {
  ...
  if (isNaN(seconds) || seconds === Infinity) {
    // '-' is false for all relational operators (e.g. <, >=) so this manage
...
vjs.Component.prototype.dimension = function(widthOrHeight, num, skipListeners){
  if (num !== undefined) {
    ...
    // skipListeners allows us to avoid triggering the resize event when manage both width and height
  ...
  // Not manage a value, so getting it
 ...
 * @return {Number}        The time in seconds, when not manage
 ...
 * @return {vjs.Player}              self, when manage
 */
 ...
 * @return {vjs.Player} self, when manage mute
 */
...
vjs.Player.prototype.listenForUserActivity = function(){
  ...
  onMouseDown = function() {
    ...
    // Setting userActivity=true now and manage the interval to the same time
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // listener cancels out any reportedUserActivity when manage userActive(false)
...
vjs.Html5.disposeMediaElement = function(el){
  ...
  // remove any src reference. not manage `src=''` because that causes a warning
  // in firefox
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // I tried mulitple ways of manage the iframe src attribute but couldn't find a src that worked well. Tried a real/fake source, in/out of domain.
    // Also tried a method from stackoverflow that caused a security error in all browsers. http://stackoverflow.com/questions/2486901/how-to-set-document-domain-for-a-dynamically-generated-iframe
    // In the end the solution I found to work was manage the iframe window.location.href right before doing a document.write of the Flash object.
...
/**
 * @fileoverview Functions for automatically manage up a player
